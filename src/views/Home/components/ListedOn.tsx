...
import { Card, CardBody, Heading, Image, Text } from 'glassswap-uikit'
  ...
  return (
    <StyledListedOn>
      <CardBody>
        ...
        <LinkListed>
          <a href="https://www.dapp.com/app/glassswap" target="_blank" rel="noreferrer">
            <Image
        ...
        <LinkListed>
          <a href="https://dappradar.com/binance-smart-chain/defi/glassswap" target="_blank" rel="noreferrer">
            <Image
        ...
        {/* <LinkListed>
          <a
            href="https://dex.apeswap.finance/#/swap?outputCurrency=0xc0699dcAf5AE66D36881cae93120c851dB6986c1"
            target="_blank"
            rel="noreferrer"
          >
            <Image
