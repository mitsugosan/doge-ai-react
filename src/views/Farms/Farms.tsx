  ...
  const farmsList = useCallback(
    (farmsToDisplay): FarmWithStakedValue[] => {
      ...
      let farmsToDisplayWithAPY: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        //   return farm
        // }
        const cakeRewardPerBlock = new BigNumber(farm.winePerBlock || 1)
    ...
    <>
      <Header>
        <Heading as="h1" size="xxl" color="secondary" mb="24px">
          {tokenMode
            ? TranslateString(10002, 'Stake tokens to earn WINE')
            : TranslateString(320, 'Stake LP tokens to earn WINE')}
        </Heading>
        <Heading size="lg" color="text">
          {TranslateString(10000, 'Deposit Fee will be used to buyback WINE')}
        </Heading>
        {/* <Text>
          <AddressLink
            href="https://doc.glassswap.money/tokennomics/burn-mechanism-and-fee-farming"
            color="text"
            external
          >
