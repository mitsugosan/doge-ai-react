...
import { Heading, Text, Flex, ChevronRightIcon } from 'glassswap-uikit'
  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'GlassSwap Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          'GlassSwap Collectibles are special ERC-721 NFTs that can be used on the GlassSwap platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved GlassSwap Collectibles won't be shown here.",
        )}
      </Text>
